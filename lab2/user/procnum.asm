...
user/_procnum:     file format elf64-littleriscv
...
main(int argc, char *argv[])
{
  ...
  12:	83258593          	addi	a1,a1,-1998 # 840 <malloc+0xe8>
  16:	4509                	li	a0,2
  18:	00000097          	auipc	ra,0x0
  1c:	654080e7          	jalr	1620(ra) # 66c <fprintf>
    exit(1);
  20:	4505                	li	a0,1
  22:	00000097          	auipc	ra,0x0
  26:	2e8080e7          	jalr	744(ra) # 30a <exit>
  }
  ...
  if ((procnum(&num)) < 0) {
  30:	fec40513          	addi	a0,s0,-20
  34:	00000097          	auipc	ra,0x0
  38:	376080e7          	jalr	886(ra) # 3aa <procnum>
  3c:	02054163          	bltz	a0,5e <main+0x5e>
    fprintf(2, "procnum failed!\n");
    exit(1);
  }

  printf("Number of process: %d\n", num);
  40:	fec42583          	lw	a1,-20(s0)
  44:	00001517          	auipc	a0,0x1
  48:	83450513          	addi	a0,a0,-1996 # 878 <malloc+0x120>
  4c:	00000097          	auipc	ra,0x0
  50:	64e080e7          	jalr	1614(ra) # 69a <printf>
  exit(0);
  54:	4501                	li	a0,0
  56:	00000097          	auipc	ra,0x0
  5a:	2b4080e7          	jalr	692(ra) # 30a <exit>
    fprintf(2, "procnum failed!\n");
  5e:	00001597          	auipc	a1,0x1
  62:	80258593          	addi	a1,a1,-2046 # 860 <malloc+0x108>
  66:	4509                	li	a0,2
  68:	00000097          	auipc	ra,0x0
  6c:	604080e7          	jalr	1540(ra) # 66c <fprintf>
    exit(1);
  70:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40a:	49250513          	addi	a0,a0,1170 # 898 <digits>
 40e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d6:	3c6b8b93          	addi	s7,s7,966 # 898 <digits>
 ...
 616:	27e90913          	addi	s2,s2,638 # 890 <malloc+0x138>
        while(*s != 0){
